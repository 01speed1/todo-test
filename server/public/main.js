...
/* harmony import */ var _services_todo_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/todo-service.service */ "./src/app/services/todo-service.service.ts");
/* harmony import */ var angular2_moment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! angular2-moment */ "./node_modules/angular2-moment/index.js");
...
/* harmony import */ var _components_shared_navbar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/shared/navbar.component */ "./src/app/components/shared/navbar.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_shared_navbar_component__WEBPACK_IMPORTED_MODULE_7__["NavbarComponent"]
            ],
            imports: [
            ...
            providers: [
                _services_todo_service_service__WEBPACK_IMPORTED_MODULE_3__["TodoServiceService"]
            ],
...
/***/ "./src/app/components/shared/navbar.component.html":
/*!*********************************************************!*\
  !*** ./src/app/components/shared/navbar.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "<nav>\n    <div class=\"nav-wrapper\">\n      <a href=\"#\" class=\"brand-logo\">TODO Oscar Guzman</a>\n      <ul id=\"nav-mobile\" class=\"right hide-on-med-and-down\">\n        <li><a href=\"https://about.me/o1speed1\">about.me</a></li>\n      </ul>\n    </div>\n  </nav>"

/***/ }),

/***/ "./src/app/components/shared/navbar.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/components/shared/navbar.component.ts ***!
  \*******************************************************/
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-navbar',
            template: __webpack_require__(/*! ./navbar.component.html */ "./src/app/components/shared/navbar.component.html"),
            styles: []
        }),
...
module.exports = ".tachado{text-decoration:line-through;}"
...
var TodosComponent = /** @class */ (function () {
    ...
    TodosComponent.prototype.deleteItem = function (item) {
        var _this = this;
        this._ts.deleteTodo(item).subscribe(function (value) {
            if (value['Ok'])
                _this.getAllTodos();
        });
    };
    TodosComponent.prototype.editItem = function () {
        var _this = this;
        var id = this.todoEditing._id;
        this.todoEditing = this.TodoForm.value;
        console.log(this.todoEditing);
        this._ts.editTodo(id, this.todoEditing).subscribe(function (value) {
            console.log(value);
            if (value) {
                _this.getAllTodos();
    ...
    TodosComponent.prototype.prepareToEdit = function (todo) {
        this.editing = true;
        this.todoEditing = todo;
        this.TodoForm.patchValue(todo);
    };
    TodosComponent.prototype.completarTarea = function (todo) {
        todo.complete_todo = !todo.complete_todo;
        console.log(todo);
        this._ts.editTodo(todo._id, todo).subscribe(function (value) {
            console.log(value);
        });
    };
    TodosComponent.prototype.getAllTodos = function () {
        var _this = this;
        this._ts.getAllTodos().subscribe(function (value) {
            _this.allTodos = value['todos'];
            console.log(value['todos']);
        });
    };
    TodosComponent.prototype.saveTodo = function () {
        var _this = this;
        if (!this.TodoForm.dirty && !this.TodoForm.valid)
            console.log("invalid form");
        var newTodo = this.TodoForm.value;
        newTodo.complete_todo = false;
        this._ts.addTodo(newTodo).subscribe(function (value) {
            if (value)
                _this.getAllTodos();
        });
        //this.getAllTodos()
    ...
    TodosComponent.prototype.buildTodoForm = function () {
        this.TodoForm = this.fb.group({
            text_todo: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            complete_todo: false
        });
    };
    TodosComponent.prototype.today = function () { return new Date(); };
    TodosComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_todo_service_service__WEBPACK_IMPORTED_MODULE_2__["TodoServiceService"],
...
var TodoServiceService = /** @class */ (function () {
    function TodoServiceService(http) {
        this.http = http;
        this.url = "http://localhost:8081/todo";
    }
    TodoServiceService.prototype.getAllTodos = function () {
        return this.http.get(this.url);
    };
    TodoServiceService.prototype.addTodo = function (todo) {
        return this.http.post(this.url, todo);
    };
    TodoServiceService.prototype.editTodo = function (id, todo) {
        var editUrl = this.url + "/" + id;
        return this.http.put(editUrl, todo);
    };
    TodoServiceService.prototype.deleteTodo = function (todo) {
        var delUrl = this.url + "/" + todo._id;
        console.log(delUrl);
...
module.exports = __webpack_require__(/*! C:\Users\Oscar\Desktop\todo-prueba\src\main.ts */"./src/main.ts");
